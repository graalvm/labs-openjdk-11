...
final class HotSpotResolvedObjectTypeImpl extends HotSpotResolvedJavaType implements HotSpotResolvedObjectType, MetaspaceObject {
    ...
    public String getSourceFileName() {
        HotSpotVMConfig config = config();
        final int sourceFileNameIndex = UNSAFE.getChar(getKlassPointer() + config.instanceKlassSourceFileNameIndexOffset);
    ...
    public long prototypeMarkWord() {
        ...
        if (isArray()) {
            ...
            return UNSAFE.getAddress(getKlassPointer() + config.prototypeMarkWordOffset);
        }
    }
    ...
    private int getMiscFlags() {
        return UNSAFE.getInt(getKlassPointer() + config().instanceKlassMiscFlagsOffset);
    }
